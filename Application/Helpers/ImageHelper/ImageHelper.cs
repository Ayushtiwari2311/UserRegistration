...
namespace Application.Helpers.ImageHelper
{
	public class ImageHelper
	{
		...
		public string GenerateImageUrl(string? folderName = null, string? fileName = null)
		{
			...
			folderName = string.IsNullOrEmpty(folderName) ? "AppUserProfileImages" : folderName;
			fileName = string.IsNullOrEmpty(fileName) ? "client.png" : fileName;
